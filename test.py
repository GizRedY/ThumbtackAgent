...
def test_gpt_client():
    ...
    try:
        ...
        test_lead = Lead(
            ...
            description="I need a photographer for my wedding on June 15th. Budget is around $300-500.",
        ...
        quote_response = client.generate_quote_response(test_lead, analysis.suggested_price or 400)
